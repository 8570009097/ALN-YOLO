...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in [nn.Conv2d, Conv, RobustConv, RobustConv2, DWConv, GhostConv, RepConv, RepConv_OREPA, DownC, 
                 ...
                 Yolov7x_E_ELAN,GSConv,VoVGSCSP,VoVGSCSPC,PConv,PDConv,PDBottleneck,Yolov7_E_ELAN_PConv,DCNv2,Yolov7_E_ELAN_DCNV,SPPCSPC_ATT,GSConvns,VoVPDCSP,PD_ELAN]:
            c1, c2 = ch[f], args[0]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/training/yolov7-tiny-goldyolo.yaml', help='model.yaml')
